...
/**
 * @author meiji 对象锁实例1，同步代码块锁（自己指定锁对象）
 */
public class SynchronizedObjectBlock1 implements Runnable {
    ...
    public void run() {
        synchronized (this) {
            ...
            System.out.println("我是对象锁的同步代码块形式我叫：" + Thread.currentThread().getName());
            try {
                // 让线程休眠3秒
                Thread.sleep(3000);
